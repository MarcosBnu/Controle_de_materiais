...
def teste():
    ...
    Inquilinos4 =materiais(materiais_nome="escova", imagem="100_0490 - Copia - Copia.jpg", descricao="dentes", ativo="Ativo", data="2022-07-02")
    Inquilinos5 =comentarios(comentario="macoto", material="1", user="1", data="2202")
